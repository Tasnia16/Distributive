...
export class DashboardComponent {
  ...
  posts: any[] = [];
  userMail: string = ''; // Define the userMail property here
  ...
  fetchPosts(): void {
    ...
    const url = `http://localhost:4002?userMail=${this.userMail}`;
  ...
  fetchImages(): void {
    ...
    // this.http.get<any[]>('http://localhost:3002/images').subscribe(
    //   (response) => {
